        ...
        return {
            ...
            onOk: function () {
                ...
                if(img.parent("figure")){
                   element = img.parent("figure");
                    caption = editor.document.createElement('figcaption');
                }else{
                   element = editor.document.createElement('figure');
                    caption = editor.document.createElement('figcaption');
                }
                element.setStyle('height', img.getAttribute('height') + 'px');
                element.setStyle('width', img.getAttribute('width') + 'px');
                element.setAttribute('class', 'align' + img.getAttribute('align'));
                caption.setHtml(img.getAttribute('title'));
